...
const FAQS = [
  ...
  },
  {
    ...
    a: "We're going hard from the jump! Our DJs will be dropping sets right up until the bar closes. We're packing all that Cinco de Mayo energy into one massive session, so make sure you're front and center early — once the bar shuts, the music stops, and we all head out (or pass out).",
  },
  {
    q: "Can I book multiple locations?",
    a: "We love the energy, but physics is a hater. These parties are all happening on the same night, so you can't exactly be in two places at once. Pick the Mad Monkey you want to be at on Cinco de Mayo and commit!",
  },
  {
    q: "Refund policy?",
